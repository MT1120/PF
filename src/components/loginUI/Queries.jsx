                            ...
                            <form onSubmit={e => { e.preventDefault(); submitCode(); }}>
                                <div class="w-full mb-4    rounded-lg bg-[#00008E] ">
                                    <div class="px-4 py-2 bg-white rounded-t-lg ">
                                        ...
                                        <textarea id="comment" rows="4" class="w-full h-[200px] px-0 text-sm text-home bg-white border-0  focus:ring-0 dark:text-home dark:placeholder-gray-400" placeholder="Your query here" value={code} onChange={e => setCode(e.target.value)} required ></textarea>
                                    </div>
