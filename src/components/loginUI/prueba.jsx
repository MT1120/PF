                            ...
                            <form>
                                <div className="w-full mb-4    rounded-lg bg-[#00008E] ">
                                    <div className="px-4 py-2 bg-white rounded-t-lg ">
                                        ...
                                        <textarea id="comment" rows="4" className="w-full h-[200px] px-0 text-sm text-home bg-white border-0  focus:ring-0 dark:text-home dark:placeholder-gray-400" placeholder="" required ></textarea>
                                    </div>
