                ...
                <div className="flex flex-col flex-1 ml-3 mr-3 mt-3  w-[25rem] items-center relative overflow-x-hidden ">
                    ...
                    <div className='mb-3 mt-3 bg-white  max-w-full w-[800px] h-[95svh] rounded-3xl   overflow-y-auto overflow-x-hidden'>
                        ...
                        <div className='flex flex-row flex-1 text-home p-5 ml-5 text-lg w-full  justify-between'>
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver} onDrop={handleDrop} >
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver2} onDrop={handleDrop2} >
                                {/* <div className='bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4' >
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver3} onDrop={handleDrop3} >
                                {/* <div className='bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4' >
                        ...
                        <div className='flex flex-row flex-1 text-home p-5 ml-5 text-lg w-full  justify-between'>
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver4} onDrop={handleDrop4} >
                                {/* <div className='bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4' >
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver5} onDrop={handleDrop5} >
                                {/* <div className='bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4' >
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver6} onDrop={handleDrop6} >
                                {/* <div className='bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4' >
                        ...
                        <div className='flex flex-row flex-1 text-home p-5 ml-5 text-lg w-full  justify-between'>
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver7} onDrop={handleDrop7} >
                                {/* <div className='bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4' >
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver8} onDrop={handleDrop8} >
                                {/* <div className='bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4' >
                            ...
                            <div className="bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4" onDragOver={handleDragOver9} onDrop={handleDrop9} >
                                {/* <div className='bg-[#00008E] rounded-xl w-[6.8rem] h-[2.5rem] mr-4' >
